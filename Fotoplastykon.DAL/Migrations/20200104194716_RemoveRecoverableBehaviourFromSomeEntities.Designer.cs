...
namespace Fotoplastykon.DAL.Migrations
{
    ...
    [Migration("20200104194716_RemoveRecoverableBehaviourFromSomeEntities")]
    partial class RemoveRecoverableBehaviourFromSomeEntities
    {
            ...
            modelBuilder.Entity("Fotoplastykon.DAL.Entities.Concrete.Quiz", b =>
                {
                    b.HasOne("Fotoplastykon.DAL.Entities.Concrete.StoredFileInfo", "Photo")
                        .WithOne("QuizPhoto")
                        .HasForeignKey("Fotoplastykon.DAL.Entities.Concrete.Quiz", "PhotoId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
